...
#' @param proj.out A character string specifying the PROJ.4 projection arguments for the output. See \code{\link[sp]{CRS}} and \href{https://proj.org/}{proj.org}. SIMPLIFY THIS!
...
#' @seealso \code{\link{vector_bathymetry}}
#' @export
