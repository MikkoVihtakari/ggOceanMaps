...
#' @param proj.bathy A character string specifying the PROJ6 projection arguments for the input (\code{bathy}). Only required if \code{bathy} lacks CRS information. If missing, \code{"+init=epsg:4326"} is assumed.
...
# bathy = file.path(etopoPath, "ETOPO1_Ice_g_gmt4.grd"); depths = c(50, 300, 500, 1000, 1500, 2000, 4000, 6000, 10000); proj.out = "+init=epsg:3996"; proj.bathy = "+init=epsg:3996", file.name = NULL; boundary = c(-180.0083, 180.0083, -90, 90); aggregation.factor = 6
