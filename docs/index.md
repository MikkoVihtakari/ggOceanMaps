...
![Bathymetric basemap of the North Atlantic/Arctic with a red polygon
overlaid, demonstrating basemap() with data= and
transform_coord().](reference/figures/README-unnamed-chunk-4-1.png)
