...
![Bathymetric basemap of the North Atlantic and Arctic with a red
rectangle outlining a data box, illustrating basemap() with bathymetry
and transform_coord().](reference/figures/README-unnamed-chunk-4-1.png)
